...
LABELS = {
    "English": {
        ...
        "UIMCommissioner": "UIM Sports Commissioner", "PostedOn": "Posted on", "PrintedAt": "Printed at",
    ...
    "Estonian": {
        ...
        "UIMCommissioner": "UIM spordikomissar", "PostedOn": "Postitatud", "PrintedAt": "Prinditud",   # NOTE: owner to verify
